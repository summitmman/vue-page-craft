...
import{d as o,aR as a,o as r,a as d,a1 as i,i as c,j as l,_ as p}from"./index-BCaH7Z-I.js";const _=o({__name:"VIf",props:{condition:{type:[String,Number,Boolean,Object,Function],required:!1},vElseChildren:{type:Array,default:()=>[]},widgets:{type:Object,default:()=>{}},events:{type:Object,default:()=>{}},state:{type:Object,default:()=>{}},store:{type:Object,default:()=>{}}},setup(t){const n=l(()=>p(()=>import("./WidgetsRenderer-CCWe58WA.js"),__vite__mapDeps([0,1,2,3]))),e=t;return(s,u)=>(typeof e.condition=="function"?e.condition():e.condition)?a(s.$slots,"default",{key:0}):e.vElseChildren.length?(r(),d(i(n),{key:1,schema:e.vElseChildren,widgets:e.widgets,events:e.events,state:e.state,store:e.store},null,8,["schema","widgets","events","state","store"])):c("",!0)}});export{_ as default};
